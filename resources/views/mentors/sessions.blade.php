<x-app-layout>
    ...
    <section class=" relative border p-2 border-gray-200 rounded-lg shadow">
        @session('success')
            <div id="toast-success"
                class="flex absolute items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 float-right"
                role="alert">
                <div
    ...
    <section>
        ...
        <div id="drawer-right-example"
            ...
            <form class="mb-6" method="POST" action="{{ route('mentor.sessions.store') }}">
                @csrf
                <div class="mb-6">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Le
                        domaine</label>
                    <input type="text" id="title" name="titre"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="#infomatique" required />
                </div>
                <div class="mb-6">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votre
                        contenu</label>
                ...
                <div class="mb-4">
                    <label for="guests" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Image
                        d'ullusration
                    </label>

                    <input
                        class="block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                        id="large_size" name="images[]" multiple type="file">
                ...
                <tbody>
                    ...
                    @forelse ($sessions as $session)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{formatDateToWords($session->created_at)}}
                            </td>
                    ...
                    @empty
                    <h5>Aucune sessions disponible</h5>
                    @endforelse
