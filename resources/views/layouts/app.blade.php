    ...
    <div x-data="{ menuOpen: false }" class="flex min-h-screen custom-scrollbar">
        ...
        <aside :class="menuOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="py-10 custom-scrollbar">
                    ...
                    <div x-data="{ linkHover: false, linkActive: false }">
                        <div @mouseover = "linkHover = true" @mouseleave = "linkHover = false"
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition duration-200"
                                    :class="linkHover || linkActive ? 'text-gray-100' : ''" fill="none"
                ...
                @endif
                <!-- start::Menu link -->
                @if (auth()->user()->hasRole('super_admin|mentor|client'))
                ...
                <!-- start::Menu link -->
                @if (auth()->user()->hasRole('super-admin|mentor'))
        ...
        <div class="flex flex-col w-full lg:pl-64">
            ...
            <div class="flex flex-col">
                <header
                    class="fixed z-50 flex items-center justify-between w-full h-16 px-6 py-4 bg-white lg:w-full lg:px-64 sm:w-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div x-data="{ linkActive: false }" class="relative mx-6">
                            ...
                            <div @click="linkActive = !linkActive" class="flex cursor-pointer">
                                <svg class="w-6 h-6 cursor-pointer hover:text-primary" fill="none"
                        ...
                        <div x-data="{ linkActive: false }" class="relative">
                            ...
                            <!-- start::Submenu -->
                            <div x-show="linkActive" @click.away="linkActive = false" x-cloak
                                class="absolute right-0 z-20 w-40 border-gray-300 top-11">
                                <!-- start::Submenu content -->
