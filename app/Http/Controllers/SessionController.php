...
class SessionController extends Controller
{
    ...
    public function index()
    {
        ...
        $sessions = SessionMentorat::where("mentor_id", $mentor->id)->get();
